  ...
  return (
    <div className="fixed top-4 right-4 z-50 space-y-2">
      {notifications.map((notification) => (
        <div
          key={notification.id}
          className={`notification max-w-sm w-full bg-white rounded-lg shadow-large border ${getNotificationStyles(notification.type)} animate-slide-up`}
        >
          <div className="p-4">
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-shrink-0">
                <button
                  ...
                  className="inline-flex text-secondary-400 hover:text-secondary-600 focus:outline-none focus:text-secondary-600 transition-colors duration-150"
                >
